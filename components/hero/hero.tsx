...
import { RotatingDnaShell } from "./rotating-dna-shell";
...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/*
        Nav contents are pushed right with a viewport-relative left padding so
        they sit clear of the DNA on the left side. Right padding stays at the
        usual margin so the hamburger stays anchored to the edge.
      */}
